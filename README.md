...
> **Credits**: Built on [DocuSeal](https://docuseal.co) by [DocuSeal](https://github.com/docusealco). All trademarks belong to their respective owners.
...
**What you get:**
- Single DocuSeal instance on Kubernetes
...
**What you get:**
- Auto-scaling DocuSeal pods on Kubernetes behind a load balancer
...
Found an issue? [Open a ticket](https://github.com/stackblaze-templates/docuseal/issues).
